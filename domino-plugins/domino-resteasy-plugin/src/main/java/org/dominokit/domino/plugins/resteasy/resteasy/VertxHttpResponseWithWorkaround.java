...
public class VertxHttpResponseWithWorkaround extends VertxHttpResponse {
  ...
  public VertxHttpResponseWithWorkaround(
      HttpServerResponse response, ResteasyProviderFactory providerFactory) {
    super(response, providerFactory);
    this.response = response;
  }

  public VertxHttpResponseWithWorkaround(
      HttpServerResponse response, ResteasyProviderFactory providerFactory, HttpMethod method) {
