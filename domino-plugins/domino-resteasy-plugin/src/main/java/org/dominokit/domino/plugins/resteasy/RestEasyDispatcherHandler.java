...
public class RestEasyDispatcherHandler implements Handler<RoutingContext> {
  ...
  public RestEasyDispatcherHandler(
  ...
  public RestEasyDispatcherHandler(
      PluginContext context, ResteasyDeployment deployment, List<Plugin> plugins) {
  ...
  public void handle(RoutingContext event) {
    ...
    io.vertx.reactivex.core.http.HttpServerRequest rxRequest =
        io.vertx.reactivex.core.http.HttpServerRequest.newInstance(request);
    Context ctx = vertx.getOrCreateContext();
    ResteasyUriInfo uriInfo =
        VertxUtil.extractUriInfo(rxRequest.getDelegate(), servletMappingPrefix);
    ...
    VertxHttpResponse vertxResponse =
        new VertxHttpResponseWithWorkaround(
            response.getDelegate(), dispatcher.getProviderFactory(), request.method());
    VertxHttpRequest vertxRequest =
        new VertxHttpRequest(
            ctx.getDelegate(),
            headers,
            uriInfo,
            request.rawMethod(),
