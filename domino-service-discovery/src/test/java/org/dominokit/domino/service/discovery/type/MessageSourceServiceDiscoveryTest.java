...
public class MessageSourceServiceDiscoveryTest extends BaseVertxServiceDiscoveryTest {
  ...
  private void publishMessageSourceService(
  ...
  public void
      givenServiceDiscovery_whenPublishingMessageSourceWithNullName_thenShouldThrowException()
          throws Exception {
  ...
  @Test(expected = BaseServiceConfiguration.InvalidServiceNameException.class)
  public void
      givenServiceDiscovery_whenPublishingMessageSourceWithEmptyName_thenShouldThrowException()
          throws Exception {
  ...
  @Test(expected = BaseServiceConfiguration.InvalidServiceNameException.class)
  public void
      givenServiceDiscovery_whenPublishingMessageSourceWithOnlySpacesName_thenShouldThrowException()
          throws Exception {
  ...
  public void
      givenServiceDiscovery_whenPublishingMessageSourceWithNullAddress_thenShouldThrowException()
          throws Exception {
  ...
  @Test(expected = AddressableServiceConfiguration.InvalidServiceAddressException.class)
  public void
      givenServiceDiscovery_whenPublishingMessageSourceWithEmptyAddress_thenShouldThrowException()
          throws Exception {
  ...
  @Test(expected = AddressableServiceConfiguration.InvalidServiceAddressException.class)
  public void
      givenServiceDiscovery_whenPublishingMessageSourceWithOnlySpacesAddress_thenShouldThrowException()
          throws Exception {
    publishMessageSourceService(new MessageSourceConfiguration(SERVICE_NAME, ONLY_SPACES));
  }

  @Test
  public void givenServiceDiscovery_whenPublishingMessageSource_thenServiceMustBePublished(
  ...
  @Test
  public void
      givenServiceDiscovery_whenPublishingMessageSourceWithMessageType_thenServiceMustBePublishedWithThatType(
          TestContext context) throws Exception {
    publishMessageSourceService(
        messageSourceConfiguration.messageType(TestMessageType.class),
        context.asyncAssertSuccess(
            record -> {
              context.assertEquals(
                  TestMessageType.class.getName(), record.getMetadata().getString("message.type"));
            }));
  }

  @Test
  public void
      givenServiceDiscovery_whenPublishingMessageSourceWithMetadata_thenServiceMustBePublishedWithThatMetadata(
          TestContext context) throws Exception {
    publishMessageSourceService(
        messageSourceConfiguration.metadata(metadata),
        context.asyncAssertSuccess(
            record -> {
  ...
  @Test
  public void
      givenServiceDiscovery_whenPublishingMessageSourceAndAskingForItsConsumer_thenShouldGetTheConsumer(
          TestContext context) throws Exception {
    publishMessageSourceService(messageSourceConfiguration);
    vertxServiceDiscovery
        .messageSource()
        .getConsumer(record -> record.getName().equals(SERVICE_NAME), context.asyncAssertSuccess());
  }

  @Test
  public void
      givenServiceDiscovery_whenPublishingMessageSourceAndAskingForItsConsumerByJson_thenShouldGetTheConsumer(
          TestContext context) throws Exception {
    publishMessageSourceService(messageSourceConfiguration);
    vertxServiceDiscovery
        .messageSource()
        .getConsumer(new JsonObject().put("name", SERVICE_NAME), context.asyncAssertSuccess());
  }
}
