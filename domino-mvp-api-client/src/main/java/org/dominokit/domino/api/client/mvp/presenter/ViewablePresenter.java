...
public abstract class ViewablePresenter<V extends View> extends AbstractPresenter {

  public static final Logger LOGGER = Logger.getLogger(ViewablePresenter.class.getName());
  ...
  private void registerSlots() {
    ...
    getName().ifPresent(name -> ClientApp.make().namedPresenters().registerPresenter(name));
  }
  ...
  private DominoView.RemovedHandler getViewRemoveHandler() {
    return () -> {
      ...
      deActivate();
      getName().ifPresent(name -> ClientApp.make().namedPresenters().removePresenter(name));
    };
  }
