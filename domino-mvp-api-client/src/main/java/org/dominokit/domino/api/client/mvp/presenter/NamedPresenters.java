...
public class NamedPresenters {
  ...
  public static void registerPresenter(String name) {
  ...
  public static void removePresenter(String name) {
  ...
  public static void whenPresent(String name, ParentFunction parentFunction) {
    String key = name.toLowerCase();
  ...
  private static void addFunction(String key, ParentFunction parentFunction) {
    if (!PARENT_FUNCTIONS.containsKey(key)) {
