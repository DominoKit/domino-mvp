...
import com.progressoft.brix.domino.apt.client.processors.module.client.requests.PathsCollector;
...
public class ClientModuleAnnotationProcessor extends BaseProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        try {
            ...
            Register pathsRegister = new Register("paths", paths, messager, processingEnv);
            ...
            new ViewsCollector(elementFactory, views).collectViews(roundEnv);
            ...
            new PathsCollector(typeUtils, elementFactory, paths).collectPaths(roundEnv);
        } catch (Exception e) {
    ...
    private void generateModuleConfiguration(ProcessorElement element) {
        try (Writer sourceWriter = obtainSourceWriter(element.elementPackage(),
            ...
            String clazz = new ModuleConfigurationSourceWriter(element, presenters, views, requests, initialTasks,
                    contributions, senders, paths).write();
