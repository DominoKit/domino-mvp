...
public class VertxServiceDiscoveryTest extends BaseVertxServiceDiscoveryTest {
  ...
  protected void onSetup() {
    ...
    record =
        new Record()
            ...
            .setLocation(new JsonObject().put("endpoint", "endpoint"));
  ...
  private void lookupIncludeOutOfService(
  ...
  private void lookupAllIncludeOutOfService(
      Function<Record, Boolean> filter, Handler<AsyncResult<List<Record>>> handler) {
  ...
  @Test
  public void givenServiceDiscovery_whenPublishingRecord_thenTheRecordShouldBePublished(
  ...
  public void givenServiceDiscovery_whenLookupForARecordWithNullFilter_thenShouldThrowException()
      throws Exception {
    lookup(null, ar -> {});
  }

  @Test
  public void givenServiceDiscovery_whenLookupForARecordUnmatchingPredicate_thenShouldGetNullRecord(
      TestContext context) throws Exception {
    publishTestRecord(record);
    lookup(
        r -> r.getName().equals(NOT_EXISTED_NAME), context.asyncAssertSuccess(context::assertNull));
  }

  @Test
  public void givenServiceDiscovery_whenLookupForARecordMatchingPredicate_thenShouldGetTheRecord(
      TestContext context) throws Exception {
    publishTestRecord(record);
    lookup(
        r -> r.getName().equals(SERVICE_NAME),
  ...
  @Test(expected = InvalidFilterException.class)
  public void
      givenServiceDiscovery_whenLookupForARecordIncludingOutOfServicePassingNullFilter_thenShouldThrowException(
          TestContext context) throws Exception {
  ...
  @Test
  public void
      givenServiceDiscovery_whenLookupForARecordIncludingOutOfService_thenShouldGetTheRecord(
          TestContext context) throws Exception {
  ...
  @Test
  public void givenServiceDiscovery_whenLookupByJsonForARecordPassingNull_thenShouldGetTheRecord(
      TestContext context) throws Exception {
    publishTestRecord(record);
    lookupByJson(
        null,
  ...
  @Test
  public void
      givenServiceDiscovery_whenLookupByJsonForARecordWithAName_thenShouldGetARecordWithThatName(
          TestContext context) throws Exception {
    publishTestRecord(record);
    lookupByJson(
        jsonFilter,
  ...
  @Test(expected = InvalidFilterException.class)
  public void
      givenServiceDiscovery_whenLookupForAllRecordsPassingNullFilter_thenShouldThrowException()
          throws Exception {
    lookupAll(null, ar -> {});
  }
  ...
  @Test
  public void
      givenServiceDiscovery_whenLookupForAllRecordsWithUnmatchingPredicate_thenShouldNotGetAnyRecord(
          TestContext context) throws Exception {
    publishTestRecord(record);
    publishTestRecord(otherRecord);
    lookupAll(
        record -> record.getName().equals(NOT_EXISTED_NAME),
        context.asyncAssertSuccess(
            records -> {
  ...
  @Test
  public void
      givenServiceDiscovery_whenLookupForAllRecordsWithMatchingPredicate_thenShouldGetAllRecordsMatching(
          TestContext context) throws Exception {
    publishTestRecord(record);
    publishTestRecord(otherRecord);
    lookupAll(
        record -> record.getName().contains(SERVICE_NAME),
        context.asyncAssertSuccess(
            records -> {
  ...
  @Test(expected = InvalidFilterException.class)
  public void
      givenServiceDiscovery_whenLookupForAllRecordsIncludingOutOfServicePassingNullFilter_thenShouldThrowException(
          TestContext context) throws Exception {
  ...
  @Test
  public void
      givenServiceDiscovery_whenLookupForAllRecordsIncludingOutOfService_thenShouldGetAllRecordsIncludingOutOfService(
          TestContext context) throws Exception {
    publishTestRecord(record.setStatus(Status.OUT_OF_SERVICE));
    publishTestRecord(otherRecord);
  ...
  @Test
  public void
      givenServiceDiscovery_whenLookupForAllRecordsByJsonPassingNull_thenShouldGetAllRecords(
          TestContext context) throws Exception {
    publishTestRecord(record);
    publishTestRecord(otherRecord);
    lookupAllByJson(
  ...
  @Test
  public void
      givenServiceDiscovery_whenLookupForAllRecordsWithNameByJson_thenShouldGetAllRecordsMatching(
          TestContext context) throws Exception {
  ...
  @Test
  public void
      givenServiceDiscovery_whenPublishServiceAndLookupForItsServiceReference_thenShouldGetTheReference(
          TestContext context) throws Exception {
    publishTestRecord(
        record,
        context.asyncAssertSuccess(
  ...
  @Test
  public void
      givenServiceDiscovery_whenPublishServiceWithMetadataAndLookupForItsServiceReferencePassingConfiguration_thenShouldGetTheReferenceUponTheseConfigurations(
          TestContext context) throws Exception {
    publishTestRecord(
        record,
        context.asyncAssertSuccess(
            record -> {
              ServiceReference reference =
                  vertxServiceDiscovery.lookupForAReferenceWithConfiguration(record, metadata);
  ...
  @Test
  public void
      givenServiceDiscovery_whenReleasingServiceObject_thenServiceDiscoveryShouldRemoveThisObjectFromBindings(
          TestContext context) throws Exception {
    publishTestRecord(
        record,
        context.asyncAssertSuccess(
            record -> {
              ...
              assertTrue(
                  serviceDiscovery.bindings().stream().noneMatch(sr -> sr.isHolding(service)));
            }));
  }
}
