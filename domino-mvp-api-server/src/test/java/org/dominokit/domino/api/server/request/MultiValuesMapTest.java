...
public class MultiValuesMapTest {
  ...
  @Test
  public void givenMap_whenGettingAllValuesForNonExistItem_ShouldReturnEmptyList()
      throws Exception {
    assertThat(map.getAll(NON_EXIST)).isEmpty();
  }

  @Test
  public void givenMap_whenGettingAllValuesForExistingItem_ShouldReturnListOfValues()
      throws Exception {
    put(KEY, VALUE_1, VALUE_2);
  ...
  @Test
  public void givenMap_whenGettingAllEntries_thenShouldReturnAllValuesInSeparateEntry()
      throws Exception {
    put(KEY, VALUE_1, VALUE_2);
  ...
  @Test
  public void givenMap_whenGettingAllEntriesWithNullValues_thenExcludeTheseItemsFromTheEntries()
      throws Exception {
    map.values.put(KEY, null);
    put(KEY_2, VALUE_12, "value22");
    assertThat(map.entries()).containsExactly(entry(KEY_2, VALUE_12), entry(KEY_2, "value22"));
  }
  ...
  @Test
  public void givenMap_whenAddValueWithExistingKey_shouldAppendTheValueToItsList()
      throws Exception {
    map.add(KEY, VALUE_1);
    map.add(KEY, VALUE_2);
  ...
  @Test
  public void givenMap_whenAddValuesWithExistingKey_shouldAppendTheValueToItsList()
      throws Exception {
  ...
  @Test
  public void givenMap_whenAddingAnotherMultiValueMapThatHasSameKey_shouldMergeTheTwoMaps()
      throws Exception {
    MultiMap<String, String> otherMap = new DefaultMultiMap<>();
  ...
  @Test(expected = NullPointerException.class)
  public void givenMap_whenAddingAnotherMultiValueMapPassingNull_shouldThrowException()
      throws Exception {
  ...
  @Test
  public void givenMap_whenSettingItemWithMultiValues_shouldClearAllValuesAndAddTheNewValues()
      throws Exception {
    map.add(KEY, VALUE_1);
  ...
  @Test(expected = NullPointerException.class)
  public void givenMap_whenSettingOtherMultiValuesMapPassingNull_shouldThrowException()
      throws Exception {
  ...
  @Test
  public void givenMap_whenAskingForIterator_thenShouldReturnIteratorContainsAllValues()
      throws Exception {
    map.add(KEY, VALUE_1);
